...
table input[type="text"]:focus, table input[type="number"]:focus, table textarea:focus,
	table select:focus {
	border-color: #007bff;
	outline: none;
	...
	<table>
		...
		<tr>
			<form action="update_user.jsp" method="post">
				<!-- User ID (Hidden Field, Read-Only Display) -->
				<td><input type="hidden" name="user_id" value="<%= id %>"><%= id %></td>
				...
				<td><input type="number" name="phone_number"
					value="<%= phoneNumber %>" required></td>

				<!-- Read-Only Registration Date -->
				<td><input type="text" name="registration_date"
					value="<%= registerDate %>" readonly></td>
				...
				<td>
					<button type="submit"
						style="background-color: #0057b8; color: white;">Update</button>

					<button type="button" style="background-color: #dc3545;"
						onclick="location.href='delete_user.jsp?passedId=<%= id %>'">
						Delete</button>
				</td>
			</form>

			<td>
				<button style="background-color: #0057b8;"
					onclick="location.href='addNewAdmin.jsp?passedId=<%= id %>'">Add</button>
				<button style="background-color: #dc3545;"
					onclick="location.href='removeAdmin.jsp?passedId=<%= id %>'">Remove</button>
			</td>
		</tr>
		<%
            }
